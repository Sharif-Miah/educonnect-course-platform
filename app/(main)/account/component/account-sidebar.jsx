...
const AccountSidebar = async () => {
  ...
  return (
    <div className="bg-white rounded-3xl p-6 sm:p-7 shadow-sm border border-slate-100/90 sticky top-24 space-y-6">
      
      {/* User Header Profile */}
      <div className="flex flex-col items-center text-center">
        
        {/* Avatar with Camera Icon and Ring */}
        <div className="relative w-28 h-28 rounded-full overflow-hidden ring-4 ring-indigo-50 shadow-md bg-slate-100 group">
          <Image
            src={avatarUrl}
            alt={fullName}
            fill
        ...
        <div className="mt-4 space-y-1">
          ...
          <div className="pt-2 flex items-center justify-center gap-2">
            <span className="bg-indigo-50 text-[#4A3AFF] text-[11px] font-bold px-3 py-1 rounded-full border border-indigo-100/60">
              Verified Student
            </span>
      ...
      {/* Quick Security Tip */}
      <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 text-xs text-slate-500 font-medium flex items-start gap-2.5">
