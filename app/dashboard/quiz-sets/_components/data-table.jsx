            ...
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  className="border-slate-100 dark:border-slate-800 hover:bg-amber-50/30 dark:hover:bg-slate-800/40 transition-colors"
                >
