      ...
      <div className="flex items-center justify-between pb-2">
        <div className="relative w-full max-w-sm">
          ...
          <input
            ...
            className="w-full bg-slate-50/70 border border-slate-200/90 rounded-2xl py-2.5 pl-10 pr-4 text-xs sm:text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-500 transition-all"
          />
        </div>
      </div>
            ...
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  className="border-slate-100 hover:bg-amber-50/30 transition-colors"
                >
